          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-4 sm:gap-8 mb-8">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs text-gray-500 uppercase tracking-wider">Закрытый</span>
              </div>
            ...
            <Link
              to="/availability"
              className="text-yellow-600/70 hover:text-yellow-500 text-sm uppercase tracking-widest transition-colors mb-6 inline-block"
            >
              Свободные даты →
            </Link>
